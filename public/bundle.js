...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Books = __webpack_require__(171);
	...
	var App = function App() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_Books2.default, null)
	  );
	};
	...
	var Search = function (_React$Component) {
	  ...
	  _createClass(Search, [{
	    ...
	    value: function emitData() {
	      ...
	      if (value.trim() !== '') {
	        _emitter2.default.emit('search-made');

	        this.getData(node.value).then(function (data) {
	          _emitter2.default.emit('new-books', { items: data.items });
	          node.value = '';
	        });
	      }
	    }
	    ...
	    value: function getData(value) {
	      return (0, _isomorphicFetch2.default)('https://www.googleapis.com/books/v1/volumes?q=' + value).then(function (resp) {
	        return resp.json();
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'text', ref: 'input', onKeyPress: this.handleKeyPress }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Book = __webpack_require__(172);
	...
	var Books = function (_React$Component) {
	  ...
	  function Books(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Books).call(this, props));
	  ...
	  _createClass(Books, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.newBooksSubscription = _emitter2.default.addListener('new-books', function (data) {
	        _this2.setState({
	          books: data.items.map(function (item) {
	            var thumbnail = item.volumeInfo.imageLinks ? item.volumeInfo.imageLinks.thumbnail : 'placeholder.jpg';
	      ...
	      this.searchMadeSubsciption = _emitter2.default.addListener('search-made', function () {
	        _this2.setState({
	          isLoading: true,
	          books: []
	        });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.state.books.map(function (book, id) {
	          return _react2.default.createElement(_Book2.default, { key: id, info: book.info });
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Book = function Book(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'a',
	      { href: info.infoLink, target: '_new' },
	      _react2.default.createElement(
	        'h3',
	    ...
	    _react2.default.createElement(
	      'a',
	      { href: info.infoLink, target: '_new' },
	      _react2.default.createElement('img', { src: info.thumbnail, width: '128', height: '193' })
	    ),
	    _react2.default.createElement(
	      'div',
	      { style: metaInfoStyle },
	      _react2.default.createElement(
	        'span',
	        { style: { color: '#006621', fontWeight: 'bold' } },
	        'Authors:'
	      ),
	      ' ',
	      info.authors.map(function (author, i) {
	        return _react2.default.createElement(
	          'span',
	          { key: i, style: { color: '#006621' } },
	          author,
	...
	Book.propTypes = {
	  info: _react2.default.PropTypes.shape({
	    title: _react2.default.PropTypes.string.isRequired,
	    infoLink: _react2.default.PropTypes.string.isRequired,
